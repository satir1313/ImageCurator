...
var canvasMaxWidth = canvasElem.width;
var canvasMaxHeight = canvasElem.height;
...
function chooseThumbnail() {
    var thumbnails = document.querySelectorAll('.thumbnail-radio');
    for (var i=0; i < thumbnails.length; ++i) {
        if (thumbnails[i].checked) {
            img.src = thumbnails[i].getAttribute("data-filename");
            changeImage();
            return;s
        }
    }
